...
DEFAULT_HOST_WORKERS = 24
DEFAULT_PLUGIN_WORKERS = 8
DEFAULT_ASYNC_LIMIT = 24
DEFAULT_HOST_GROUP_SIZE = 32
DEFAULT_HOST_TIMEOUT = 0.0
DEFAULT_STATS_EVERY = 0.0
DEFAULT_TIMING_TEMPLATE = 3
DEFAULT_SERVICE_INTENSITY = 5
